    ...
    <footer className="bg-white dark:bg-[rgb(74,87,100)] border-t border-gray-200 dark:border-white/10 py-12 px-4 transition-colors relative z-10">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-display font-semibold mb-4 text-gray-900 dark:text-white transition-colors">Bold Innovation</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors">kontakt@boldinnovation.pl</p>
          </div>
          <div>
            <h4 className="font-display font-semibold mb-4 text-gray-900 dark:text-white transition-colors">Quick Links</h4>
          ...
          <div>
            <h4 className="font-display font-semibold mb-4 text-gray-900 dark:text-white transition-colors">Follow Us</h4>
            <a
              href="#"
